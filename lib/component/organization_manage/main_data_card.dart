...
class MainDataCard extends StatefulWidget {
  final Map<String, dynamic> cardData;

  const MainDataCard({super.key, required this.cardData});

  @override
  State<MainDataCard> createState() => _MainDataCardState();
}

class _MainDataCardState extends State<MainDataCard> {
  @override
